...
export type GlowBlendMode = 'screen' | 'normal' | 'lighter' | 'plus-lighter'

export interface GlowCursorProps extends Omit<HTMLAttributes<HTMLDivElement>, 'children'> {
  color?: string
...
/**
 * WebGL cursor trail (ogl). Pointer-driven glow that sits above page content
 * without intercepting clicks. Disabled when `enabled` is false or the user
